...
try {
	...
	println 'tiempo antes de seleccionar subdeporte: '+CustomKeywords.'com.utils.ReportHelper.getHours'()
	...
	println 'tiempo despues de seleccionar subdeporte: '+CustomKeywords.'com.utils.ReportHelper.getHours'()
