...
try {
	...
	//Valida que el odd sea positivo como lo indica la prueba
	...
	betslipActualResult)+' o el odd del equipo seleccionado es negativo cuando debería ser positivo.'
