...
try {
	...
	testResultDescription = 'La información esperada del betslip era esta: '+betslipExpectedResult+ " pero actualmente es: "+betslipActualResult + " o el odd de la selección es  negativa cuando debería ser positiva"
