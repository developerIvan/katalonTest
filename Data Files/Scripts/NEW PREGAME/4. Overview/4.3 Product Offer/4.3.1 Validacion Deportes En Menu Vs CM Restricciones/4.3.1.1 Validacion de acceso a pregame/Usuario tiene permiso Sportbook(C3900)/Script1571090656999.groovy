...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.1 Validacion Deportes En Menu Vs CM Restricciones/4.3.1.1 Validacion de acceso a pregame/div_Sports'), 4)

	String permisoSportbook =	WebUI.getAttribute(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.1 Validacion Deportes En Menu Vs CM Restricciones/4.3.1.1 Validacion de acceso a pregame/div_Sports'), 'textContent', FailureHandling.STOP_ON_FAILURE)
  ...
  throw new StepFailedException(errorCode.concat(testFailedMessageDesc),step);
   ...
   throw new StepFailedException(errorCode.concat(testFailedMessageDesc),ex);
} 
finally { 
