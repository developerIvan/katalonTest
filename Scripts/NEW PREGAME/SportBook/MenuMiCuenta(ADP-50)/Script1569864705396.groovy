...
//Carga del excel  
CustomKeywords.'com.utils.ExcelUtils.loadFileInputStream'(GlobalVariable.permisosExcelRutaCasino)
...
CustomKeywords.'com.utils.ExcelUtils.loadFileOutputStream'(GlobalVariable.permisosExcelRutaCasino)
...
WebUI.callTestCase(findTestCase('NEW PREGAME/SportBook/Login_Successfull'), [('url') : findTestData('PreGameTestData').getValue(
