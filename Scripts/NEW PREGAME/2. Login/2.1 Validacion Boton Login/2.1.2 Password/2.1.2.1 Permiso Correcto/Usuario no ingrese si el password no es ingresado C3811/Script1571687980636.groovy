...
try {
	...
	testResultDescription = 'El sistema no pudo validar que el usuario no pueda rentrar al sitio si su clave no es ingresada  debido a que el mesaje de error no es el esperado o algún  elmento esperado  de la página no está visible. Favor revisar el log de katalon';
	...
	testResultDescription ='El sistema no pudo validar que el usuario no pueda entrar al sitio si su contraseña está vacia debido a un error anomalo en la prueba. Favor revisar los logs o bitacoras de katalon';
