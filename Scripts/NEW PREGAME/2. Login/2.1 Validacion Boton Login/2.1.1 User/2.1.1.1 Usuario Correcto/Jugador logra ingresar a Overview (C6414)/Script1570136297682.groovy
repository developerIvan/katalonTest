...
if (!GlobalVariable.pregameSiteEsVisible) {
	WebUI.callTestCase(findTestCase('NEW PREGAME/1. Site/1.1 Validacion del tipode sitio Classic Premium/El site muestra el boton LOGIN (C3783)'), [('url') : findTestData('PreGameTestData').getValue(3, 1)],
