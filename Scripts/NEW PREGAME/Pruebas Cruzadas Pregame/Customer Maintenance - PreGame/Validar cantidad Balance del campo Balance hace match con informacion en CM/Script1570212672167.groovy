...
def info = WebUI.callTestCase(findTestCase('NEW PREGAME/PREPARE DATA LOGIN PREGAME/PrepareDataLoginPreGameBalance'),
...
def String rutaExcel = 'C:/PROYECTOS/QAPregameNuevo/Data Files/TestData/DataLoginPregameBalance.xlsx';
...
try {
	...
	cmBalance = WebUI.callTestCase(findTestCase('CUSTOMER MAINTENANCE/Transactions/Valida que el monto del campo Balance es desplegado correctamente'),
