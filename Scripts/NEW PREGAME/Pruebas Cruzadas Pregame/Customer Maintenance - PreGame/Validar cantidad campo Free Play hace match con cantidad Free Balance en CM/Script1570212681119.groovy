...
def info = WebUI.callTestCase(findTestCase('NEW PREGAME/PREPARE DATA LOGIN PREGAME/PrepareDataLoginPreGameFreeBalance'),
		[:], FailureHandling.STOP_ON_FAILURE)

def Url_FreePlay = info.url

def UserId_FreePlay = info.userId

def Password_FreePlay = info.password
...
def String rutaExcel = 'C:/PROYECTOS/QAPregameNuevo/Data Files/TestData/DataLoginPregameFreeBalance.xlsx';
...
try {
	...
	WebUI.waitForElementNotVisible(findTestObject('Repositorio Objetos Proyecto Premium/InitModal'), 6);

	WebUI.waitForElementNotPresent(findTestObject('Repositorio Objetos Proyecto Premium/InitModal'), 6);
	...
	cmFreBalance = WebUI.callTestCase(findTestCase('CUSTOMER MAINTENANCE/Transactions/Valida que el monto del campo Free Balance es desplegado correctamente'),
	...
	/*FileOutputStream outFile =new FileOutputStream(new File("C:/Users/hsierra/Katalon Studio/Proyecto PREMIUM/Data Files/DataLoginPregameAvailable.xlsx"));
