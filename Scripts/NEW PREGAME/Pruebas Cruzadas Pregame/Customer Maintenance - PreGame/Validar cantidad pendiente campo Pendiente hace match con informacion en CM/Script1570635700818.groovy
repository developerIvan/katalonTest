...
def info = WebUI.callTestCase(findTestCase('NEW PREGAME/PREPARE DATA LOGIN PREGAME/PrepareDataLoginPreGamePending'),
		[:], FailureHandling.STOP_ON_FAILURE)

def Url_Pendient = info.url

def UserId_Pendient = info.userId

def Password_Pendient = info.password
...
def String rutaExcel = 'C:/PROYECTOS/QAPregameNuevo/Data Files/TestData/DataLoginPregamePending.xlsx';
...
try{
	...
	cmPendiente = WebUI.callTestCase(findTestCase('CUSTOMER MAINTENANCE/Transactions/Valida que el monto del campo Pending es desplegado correctamente'),
