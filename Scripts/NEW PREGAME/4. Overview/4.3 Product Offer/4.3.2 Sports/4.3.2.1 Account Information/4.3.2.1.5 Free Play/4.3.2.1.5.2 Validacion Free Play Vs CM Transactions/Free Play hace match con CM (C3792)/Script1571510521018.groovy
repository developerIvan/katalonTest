...
try {
	...
	WebUI.setText(findTestObject('Repositorio Objetos Proyecto Premium/2.1 Login/input_Welcome Back_user'), UserId_FreePlay)

	WebUI.delay(2)

	WebUI.setText(findTestObject('Repositorio Objetos Proyecto Premium/2.1 Login/input_Welcome Back_password'), Password_FreePlay)
	...
	cmFreBalance = WebUI.callTestCase(findTestCase('NEW PREGAME/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/4.3.2.1.5 Free Play/4.3.2.1.5.2 Validacion Free Play Vs CM Transactions/Consultar Free Balance de CM'),
