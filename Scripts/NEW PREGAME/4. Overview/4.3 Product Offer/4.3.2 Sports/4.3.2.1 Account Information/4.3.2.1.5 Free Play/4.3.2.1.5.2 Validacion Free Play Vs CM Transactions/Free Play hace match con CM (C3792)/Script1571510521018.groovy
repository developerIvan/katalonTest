...
try{
	...
	WebUI.waitForElementVisible(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/li_FreePlay'), 2)
		
	pregameFreeBalanceAtt = WebUI.getText(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/li_FreePlay'))
...
if (pregameFreeBalanceAtt.contains('Free Play')) {
	...
	cmFreBalance = WebUI.callTestCase(findTestCase('NEW PREGAME/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/4.3.2.1.4 Pending/4.3.2.1.4.2 Validacion Pending Vs CM Transactions/Consultar Pending de CM'),
	...
	testResultDescription = "El monto de Free Play del jugador "+userPIN+" de pregame corresponde con el pendiente de Customer Maintenance"
	...
	testResultDescription = "Se esperaba que el monto free play  del jugador "+userPIN + "  fuera: "+cmPendiente +" pero actualmente es: "+pregamePendiente;
