...
//	WebDriver driver = DriverFactory.getWebDriver()
	...
	cmDisponible = WebUI.callTestCase(findTestCase('NEW PREGAME/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/4.3.2.1.3 Available/4.3.2.1.3.2 Validacion Available Vs CM Transactions/Consultar Dsiponible de Customer Maintenance'),
