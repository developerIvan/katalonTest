...
try {
	...
	testResultDescription = ('El cehckbox de "Start From Tuesday" es visible  debido a que un paso de la prueba no se completo o un elemento de la página que no está visible. ' +
