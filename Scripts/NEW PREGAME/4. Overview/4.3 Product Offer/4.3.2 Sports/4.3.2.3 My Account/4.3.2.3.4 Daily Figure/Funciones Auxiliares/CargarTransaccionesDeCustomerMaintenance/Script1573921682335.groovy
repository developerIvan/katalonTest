...
WebUI.waitForElementVisible(findTestObject('Object Repository/Repositorio Objetos Customer Maintenance/Transactions/select_Display_Days'), 2)


//Selecciona el rango de dias de las transacciones 

//1 semana antes
if(daysBefore>= 7 && daysBefore<14){
