...
try {
	...
	assert  expectedMondayConfiguration.equals(mondayZeroOutBalance)

    testStatus = 'Exitoso'

    testResultDescription = (('El jugador "' + customerPIN) + '" tiene la configración correcta de '+expectedMondayConfiguration)
}
    ...
    testResultDescription = 'El jugador '+customerPIN+ ' debería tener la configuración de zero balance '+expectedMondayConfiguration + ' pero tiene la siguiente configuración ' +mondayZeroOutBalance + ' en su lugar ' 
