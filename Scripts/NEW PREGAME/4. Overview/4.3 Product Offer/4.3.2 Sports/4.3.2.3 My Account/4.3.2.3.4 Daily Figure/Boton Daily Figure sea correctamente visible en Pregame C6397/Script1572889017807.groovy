...
try {
	...
	WebUI.waitForElementClickable(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.3 MY ACCOUNT/4.3.2.3.1 Reports/div_MY ACCOUNT'), 2)
	...
	WebUI.waitForElementVisible(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/4.3.2.3 MY ACCOUNT/4.3.2.3.4 Daily Figure/button_DAILY FIGURE'), 2)

	String dailyFigureButtonName = WebUI.getAttribute(findTestObject('Repositorio Objetos Proyecto Premium/4. Overview/4.3 Product Offer/4.3.2 Sports/4.3.2.1 Account Information/4.3.2.3 MY ACCOUNT/4.3.2.3.4 Daily Figure/button_DAILY FIGURE'), "innerText", FailureHandling.STOP_ON_FAILURE)
	...
	testResultDescription =  'El botón de Balance Diario o Daily Figure de la sección "My Account"  no es visible debido a que un paso de la prueba no se completo o un elemento de la página que no está visible. '+CustomKeywords.'com.utils.ConstantsUtil.getCustomErrorMessageForStepExceptions'(errorCode,'C3900');
