...
try{
	...
	WebUI.waitForElementNotVisible(findTestObject('Repositorio Objetos Proyecto Premium/4.3.2.3 MY ACCOUNT/4.3.2.3.1 Reports/div_Overlay'), 2)

	//Verifico visivilidad de botón Graded
	WebUI.verifyElementVisible(findTestObject('Repositorio Objetos Proyecto Premium/4.3.2.3 MY ACCOUNT/4.3.2.3.1 Reports/button_Graded'))
