...
WebUI.waitForElementClickable(findTestObject('Repositorio Objetos Customer Maintenance/PERFOMANCE/a_Wagers'),
		4)

WebUI.click(findTestObject('Repositorio Objetos Customer Maintenance/PERFOMANCE/a_Wagers'))
