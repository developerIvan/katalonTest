...
try {
    ...
    //Selecciono la línea
    WebElement selectedLineButton = WebUI.callTestCase(findTestCase('NEW PREGAME/5. Betslip/5.1 Bet Type/Funciones Auxiliares/SeleccionarLineaAlt'), [('betType') : 'S'
        , ('selectedTeam') : favoriteTeam, ('tournament') : tournament], FailureHandling.STOP_ON_FAILURE)
    ...
    testResultDescription = (('La siguiente información de la línea   ' + betslipExpectedResult) + '  con spread positive odds se muestra correctamente')
    ...
    betslipActualResult) + ' o el odd del equipo seleccionado es positivo cuando debería ser negativo')
    ...
    testResultDescription = ('No se pudo verificar que la informaicón se refleje correctamente con un asian handicap -0.25 con underdog debido a un error anomalo en la prueba. ' + 
