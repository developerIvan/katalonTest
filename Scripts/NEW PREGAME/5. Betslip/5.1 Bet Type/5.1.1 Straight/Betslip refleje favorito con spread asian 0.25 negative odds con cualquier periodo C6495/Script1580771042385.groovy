...
try {
	...
	testResultDescription = 'La información esperada del betslip era esta: '+betslipExpectedResult+ " pero actualmente es: "+betslipActualResult + " o el odd de la selección es positivo cuando debería ser negativo"
