...
try {
	...
	WebElement selectedLineButton = WebUI.callTestCase(findTestCase('NEW PREGAME/5. Betslip/5.1 Bet Type/Funciones Auxiliares/SeleccionarLineaAlt'), [('betType') : 'S'
		, ('selectedTeam') : favoriteTeam, ('tournament') : tournament, ('period') : period], FailureHandling.STOP_ON_FAILURE)
...
//Se lee la información esperada (M<tach,Periodo,Bet type, Selectiony Line
	...
	testResultDescription = 'La siguiente información de la línea   '+betslipExpectedResult+'  con spread asian -0.75 se refleja correctamente en el betslip'
	...
	testResultDescription = 'La información esperada del betslip era : '+betslipExpectedResult+ ' pero actualmente es: '+betslipActualResult+' o el odd del equipo seleccionado es negativo cuando debería ser positivo'
