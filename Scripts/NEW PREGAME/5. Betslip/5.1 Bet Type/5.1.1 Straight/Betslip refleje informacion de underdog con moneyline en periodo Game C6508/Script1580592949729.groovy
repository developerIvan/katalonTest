...
//Se selecciona el peridodo
    ...
    testResultDescription = 'La información esperada del betslip era esta: '+betslipExpectedResult+ " pero actualmente es: "+betslipActualResult
