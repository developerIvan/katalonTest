...
try {
	...
	WebElement selectedLineButton = WebUI.callTestCase(findTestCase('NEW PREGAME/5. Betslip/5.1 Bet Type/Funciones Auxiliares/SeleccionarLineaAlt'), [('betType') : 'S'
		, ('selectedTeam') : selectedTeam, ('tournament') : tournament, ('period') : period], FailureHandling.STOP_ON_FAILURE)
	...
	testResultDescription = 'La siguiente información de la línea   '+betslipExpectedResult+'  con spread asian 0.25 se refleja correctamente en el betslip'
	...
	testResultDescription = 'La información esperadad del betslip era esta: '+betslipExpectedResult+ " pero actualmente es: "+betslipActualResult + " o el odd o precio de la linea es positivo cuando debería ser negativo"
	...
	testResultDescription = ('No se pudo verificar que la informaicón se refleje correctamente con un asian handicap -0.25  debido a un error anomalo en la prueba. ' +
