...
try {
	...
	String threshold = selectedLineButton.findElement(By.cssSelector("div.row div[class*='threshold']")).getText();
	
	WebUI.verifyEqual(threshold.toUpperCase(), 'PK')
	...
	testResultDescription = 'La información esperada del betslip era esta: '+betslipExpectedResult+ ' pero actualmente es: '+betslipActualResult + ' o el odd del equipo seleccionado es negativo cuando debería ser positivo'
