...
String color = WebUI.getAttribute(findTestObject('Object Repository/Repositorio Objetos Customer Maintenance/Personal/span_Pregame_indicator-status pointer'), "background")
