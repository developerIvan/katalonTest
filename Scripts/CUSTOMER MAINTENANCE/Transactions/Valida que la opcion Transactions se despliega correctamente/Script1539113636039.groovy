...
def Url_Tranasactions = info.url

def UserId_Tranasactions = info.userId

def Password_Tranasactions = info.password

//import com.kms.katalon.core.testobject.CoditionType as ConditionType
WebUI.openBrowser(Url_Tranasactions)

WebUI.setText(findTestObject('Repositorio Objetos Customer Maintenance/input_User_id_user'), UserId_Tranasactions)

WebUI.setText(findTestObject('Repositorio Objetos Customer Maintenance/input_Password_id_password'), Password_Tranasactions)
